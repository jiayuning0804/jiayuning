...
// ===================================================================
//  LLM 配置 — API Key 已移除，所有请求通过后端代理 /api/chat 转发
// ===================================================================
const BUILTIN_LLM = {
  provider: 'deepseek',
  baseUrl: '/api/chat',    // 通过后端代理转发，Key 安全存储在服务端
  model: 'deepseek-chat'
};
...
const DB = {
  ...
  getConfig() {
    ...
    return { ...DEFAULT_CONFIG, provider: BUILTIN_LLM.provider, model: BUILTIN_LLM.model };
  },
