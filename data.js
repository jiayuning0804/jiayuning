...
5. 为每个推荐IP提供1-2个真实的行业合作参考案例

【IP深度分析要求】
对每个推荐IP，从以下维度进行高价值分析：
- 用户画像：核心用户群体特征、年龄分布、性别比例、兴趣标签
- 消费力评估：用户付费意愿、ARPU水平、价格敏感度、对联名产品的购买力
- 高价值洞察：该IP用户群体与美团团购目标用户（到店餐饮、休闲娱乐、生活服务）的重合度，以及可挖掘的商业机会

【美团团购业务结合方向】
针对每个IP，明确指出如何与美团团购核心业务（到店餐饮、休闲娱乐、酒店旅游、丽人美业等）进行结合，给出具体可行的业务结合切入点。

【创意合作方案要求】
为每个IP提出2个创意合作方案方向：
- 每个方案需包含：方案标题、规划方向简述（含核心玩法、预期效果、适合的合作场景）
- 方案应具有可执行性和创新性，结合美团团购的平台特性（如团购券、KA商户资源、到店场景、LBS精准推送等）
- 两个方案应在合作形式上有所差异，给需求方提供选择空间
...
【字数限制】
reason 限 50 字以内，summary 限 100 字以内，analysis 各字段限 80 字以内，integration 限 100 字以内，proposals 每条 direction 限 100 字以内，案例描述每条限 80 字以内。语言精炼，直击要点。
  ...
  "recommendations": [
    {
      ...
      "analysis": {
        "users": "用户画像分析，如：核心用户18-25岁，男性占比60%，偏好竞技与社交，活跃时段集中在晚间和周末",
        "spending": "消费力评估，如：游戏内付费率约15%，ARPU较高，对限定周边有强购买意愿，价格敏感度低",
        "value": "高价值洞察，如：该IP用户群体与美团餐饮到店场景高度重合，晚间消费频次高，可结合夜宵、聚餐场景做精准转化"
      },
      "integration": "美团团购业务结合方向，如：结合美团到店餐饮KA商户资源，打造IP主题套餐+门店线下打卡活动，利用LBS精准推送触达IP核心用户群体",
      "proposals": [
        {
          "title": "创意方案标题，如：王者荣耀KPL×美团团购·冠军夜宵季",
          "direction": "规划方向，如：围绕赛事周期，联合头部餐饮品牌推出联名套餐，用户购买套餐可获得游戏内限定道具，门店设置打卡点引导社媒传播，预期活动期间参与商户GMV提升20%+"
        },
        {
          "title": "创意方案标题，如：美团团购×王者荣耀·城市荣耀战",
          "direction": "规划方向，如：基于LBS的城市战队积分赛，用户到店消费为城市积分助力，结合美团App推送触达，打通线上游戏与线下到店消费链路"
        }
      ],
      "cases": [
        {
